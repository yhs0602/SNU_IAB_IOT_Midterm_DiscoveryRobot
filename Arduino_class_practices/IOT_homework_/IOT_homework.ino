...
// ESP32 보드를 AP로 동작하게 시작하고 자신은 다른 네트워크에 연결
// SIM 모듈을 사용하면 셀룰러 네트워크를 이용하여 더 먼거리에서도 안정적인 통신 가능
void initWifiMulti()
{
...
//canvas_htm.h by Mudassar Tamboli (Apache License)
//비디오를 화면에 출력하는 HTML& JS 코드입니다.
